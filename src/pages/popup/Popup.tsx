  ...
  <>
    ...
    <div className='popup__content'>
      ...
      <div className='popup__footer'>
        <button type='button' id='copy' className='popup__button' aria-label='Copy to clipboard'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='1.2em'
            height='1.2em'
    ...
    <div id='notification' className='popup__notification'>
      <div className='popup__notification__text' />
    </div>
  </>
)
